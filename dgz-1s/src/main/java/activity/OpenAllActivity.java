...
public class OpenAllActivity extends Activity implements Adapter.OnShowItemClickListener {
    ...
    public void initView(){
                        ...
                        if (currentFiles[position - 1].isFile()) {
                            ...
                            if (strExt.equals("dgz")) {
                              ...
                              /* final String mPath = curdir.getAbsolutePath()+"/" + fileName;
                                ...
                                Toast.makeText(OpenAllActivity.this, "不是钢丝绳张紧力测试文件！", Toast.LENGTH_SHORT).show();
                                return;
                            }
        ...
        batchOpen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentFiles.length == 0) {
                    ...
                    if (listDs.size() == 0) {
                        batchOpen.setTextColor(Color.BLACK);
                        Toast.makeText(OpenAllActivity.this, "该文件夹下没有钢丝绳张紧力检测文件", Toast.LENGTH_SHORT).show();
                    } else {
        ...
        createExcel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               final ArrayList<DataBean> dataList =  pictureDB.getAllInfos(db, MyApplication.DGZFORCE);
                //获取sd卡目录
                            ...
                            if (selectList.get(i).getMsg().equals(dataList.get(j).getMsg())) {
                                ...
                                if (filename != null) {
                                    ...
                                    if (dirfile == null || !dirfile.exists()) {
                                        ...
                                        if (count2 == 1) {
                                            Toast.makeText(OpenAllActivity.this, "不能删除DGZ-1S以外的文件", Toast.LENGTH_SHORT).show();
                                            count2++;
                                        }
                                    }
