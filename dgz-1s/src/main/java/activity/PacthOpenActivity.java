...
//port
    ...
    public void addHeader(String name){
            ...
            String[] items = new String[]{name, "设备编号", "操作人员", "操作地点","张紧力值"};
    ...
    if (listDs != null && listDs.size() ==sizeDs && listDs.size() > 0 ) {
        for (int i = 0; i < listDs.size(); i++) {
            ...
            listInfo = pd.getInfos(sd, MyApplication.DGZFORCE, name);
            items = new String[]{name, listInfo.get(1), listInfo.get(2), listInfo.get(3), listInfo.get(4)};
