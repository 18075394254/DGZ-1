   ...
   private ProgressBar progressBar;
    ...
    private void onSave(String i) {
      ...
      //  MySeverityView forceView = new MySeverityView(ImportAllActivity.this, m_ForceData, m_DisData);
       ...
       // pictureDB.initDataBase(db, bitmap, MyApplication.DGZFORCE, name, MainActivity.s_mLiftId, MainActivity.s_mOperator, MainActivity.s_mLocation, force, dis,isQualified);
            map.clear();
